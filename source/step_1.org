...
:HTML_CONTAINER_CLASS: run
:END:
- Try and either modify your program or answer the questions below on a Word document. You'll be saving this circuit in your home drive later.
...
- (e.g. in the bottom-left shape, I turned output 0 on, and also turned off outputs 1 and 2). 
